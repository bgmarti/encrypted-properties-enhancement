...
public class DefaultPropertiesTestConfig {
	...
	@Bean
    static EncryptablePropertySourcesPlaceholderConfigurer encryptablePropertySourcesPlaceholderConfigurer(ConfigurableEnvironment env) {
    	...
    	EncryptablePropertySourcesPlaceholderConfigurer propertySourcesPlaceholderConfigurer = new EncryptablePropertySourcesPlaceholderConfigurer(stringEncryptor);
